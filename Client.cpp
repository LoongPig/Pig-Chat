			...
			switch(wParam) {
				case 1:{//连接 Socket
					...
					talkT=CreateWindow(L"Edit",L"",
						WS_CHILD|WS_VISIBLE|WS_BORDER|ES_AUTOHSCROLL|WS_HSCROLL|ES_MULTILINE|ES_AUTOVSCROLL|WS_VSCROLL|ES_READONLY,
						25,20,500,260,hwnd,(HMENU)10,hIns,NULL);
					writeT=CreateWindow(L"Edit",L"",
						WS_CHILD|WS_VISIBLE|WS_BORDER|ES_AUTOHSCROLL|WS_HSCROLL|ES_MULTILINE|ES_AUTOVSCROLL|WS_VSCROLL,
						25,285,400,130,hwnd,(HMENU)10,hIns,NULL);
					SendB=CreateWindow(L"Button",L"Send",
						WS_CHILD|WS_VISIBLE,
						440,285,100,130,hwnd,(HMENU)3,hIns,NULL);
